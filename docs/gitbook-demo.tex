...
Atenção: Este repositório é o \emph{backend} do livro Conceitos e Análises Estatísticas com R e JASP\\
...
Última modificação: 08 July, 2021 às 13:48
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.85}}@{}}
\toprule
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{descr}\SpecialCharTok{::}\FunctionTok{CrossTable}\NormalTok{(ds\_selected}\SpecialCharTok{$}\NormalTok{sex\_male,ds\_selected}\SpecialCharTok{$}\NormalTok{adhd\_parent,}
           \AttributeTok{expected =}\NormalTok{ T, }\AttributeTok{prop.c =}\NormalTok{ F, }\AttributeTok{prop.chisq =}\NormalTok{ F, }\AttributeTok{prop.t =}\NormalTok{ F) }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{descr}\SpecialCharTok{::}\FunctionTok{CrossTable}\NormalTok{(ds\_selected}\SpecialCharTok{$}\NormalTok{sex\_male,ds\_selected}\SpecialCharTok{$}\NormalTok{adhd\_parent,}\AttributeTok{chisq =}\NormalTok{ T)}\SpecialCharTok{$}\NormalTok{CST }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  pander}\SpecialCharTok{::}\FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rcompanion}\SpecialCharTok{::}\FunctionTok{cramerV}\NormalTok{(ds\_selected}\SpecialCharTok{$}\NormalTok{sex\_male,ds\_selected}\SpecialCharTok{$}\NormalTok{adhd\_parent)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(ds\_selected}\SpecialCharTok{$}\NormalTok{sex\_male,ds\_selected}\SpecialCharTok{$}\NormalTok{adhd\_parent, }\AttributeTok{correct =}\NormalTok{ F) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pander}\NormalTok{(., }\AttributeTok{split.table =} \ConstantTok{Inf}\NormalTok{, }\AttributeTok{caption =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(ds\_selected}\SpecialCharTok{$}\NormalTok{sex\_male,ds\_selected}\SpecialCharTok{$}\NormalTok{adhd\_parent) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  DescTools}\SpecialCharTok{::}\FunctionTok{Rev}\NormalTok{(.) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  epiR}\SpecialCharTok{::}\FunctionTok{epi.2by2}\NormalTok{(.)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{asq\_12months }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(sex) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{shapiro =} \FunctionTok{shapiro.test}\NormalTok{(total\_12)}\SpecialCharTok{$}\NormalTok{p.value) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  pander}\SpecialCharTok{::}\FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nortest}\SpecialCharTok{::}\FunctionTok{ad.test}\NormalTok{(}\FunctionTok{lm}\NormalTok{(total\_18 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ sex, }\AttributeTok{data =}\NormalTok{ asq\_18months)}\SpecialCharTok{$}\NormalTok{residuals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{apaTables}\SpecialCharTok{::}\FunctionTok{apa.aov.table}\NormalTok{(mod\_escolaridade)}\SpecialCharTok{$}\NormalTok{table\_body }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pander}\NormalTok{(., }\AttributeTok{split.table =} \ConstantTok{Inf}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.20}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.10}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.10}}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.22}}@{}}
\toprule
...
\begin{Highlighting}[]
\NormalTok{dados\_teg }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(escolaridade\_fct }\SpecialCharTok{==} \StringTok{"Colegial"} \SpecialCharTok{|} 
\NormalTok{           escolaridade\_fct }\SpecialCharTok{==} \StringTok{"ginasio"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  \{}\FunctionTok{t.test}\NormalTok{(teg }\SpecialCharTok{\textasciitilde{}}\NormalTok{ escolaridade\_fct, }\AttributeTok{var.equal =}\NormalTok{ T, }\AttributeTok{data =}\NormalTok{ .)}\SpecialCharTok{$}\NormalTok{p.value\} }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.19}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.11}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.11}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.11}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{apaTables}\SpecialCharTok{::}\FunctionTok{apa.aov.table}\NormalTok{(mod\_escolaridade\_faixa\_etaria)}\SpecialCharTok{$}\NormalTok{table\_body }\SpecialCharTok{\%\textgreater{}\%}  \FunctionTok{pander}\NormalTok{(.)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.26}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.14}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{apaTables}\SpecialCharTok{::}\FunctionTok{apa.aov.table}\NormalTok{(mod\_escolaridade\_faixa\_etaria\_fatorial)}\SpecialCharTok{$}\NormalTok{table\_body }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pander}\NormalTok{(., }\AttributeTok{split.table =} \ConstantTok{Inf}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post\_hoc\_fatorial }\OtherTok{\textless{}{-}} \FunctionTok{emmeans}\NormalTok{(mod\_escolaridade\_faixa\_etaria\_fatorial, }
\NormalTok{                             pairwise }\SpecialCharTok{\textasciitilde{}}\NormalTok{ escolaridade\_grupo }\SpecialCharTok{|} 
\NormalTok{                               faixa\_etaria, }\AttributeTok{adj =} \StringTok{"bonferroni"}\NormalTok{) }
\NormalTok{post\_hoc\_fatorial}\SpecialCharTok{$}\NormalTok{contrasts }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ data.frame }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \begin{longtable}[]{@{}
    >{\centering\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.17}}
    ...
    >{\centering\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.10}}
    >{\centering\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.14}}@{}}
  \toprule
...
\begin{Highlighting}[]
\NormalTok{tratamento }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{residuos =} \FunctionTok{proj}\NormalTok{(ez\_outcome}\SpecialCharTok{$}\NormalTok{aov)[[}\DecValTok{3}\NormalTok{]][, }\StringTok{"Residuals"}\NormalTok{]) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{residuos)) }\SpecialCharTok{+} 
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+} 
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{shapiro.test}\NormalTok{(}\FunctionTok{proj}\NormalTok{(ez\_outcome}\SpecialCharTok{$}\NormalTok{aov)[[}\DecValTok{3}\NormalTok{]][, }\StringTok{"Residuals"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ez\_outcome}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Mauchly\textquotesingle{}s Test for Sphericity}\StringTok{\textasciigrave{}} \SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(ez\_outcome}\SpecialCharTok{$}\NormalTok{aov) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  pander}\SpecialCharTok{::}\FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor.test}\NormalTok{(dados\_brasil}\SpecialCharTok{$}\NormalTok{eat\_soma, dados\_brasil}\SpecialCharTok{$}\NormalTok{bsq\_soma) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor.test}\NormalTok{(dados\_brasil}\SpecialCharTok{$}\NormalTok{eat\_soma, dados\_brasil}\SpecialCharTok{$}\NormalTok{bsq\_soma) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{imc\_medio }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(dados\_brasil}\SpecialCharTok{$}\NormalTok{imc, }\AttributeTok{na.rm=}\NormalTok{T)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sjPlot}\SpecialCharTok{::}\FunctionTok{tab\_model}\NormalTok{(mod\_risco, }\AttributeTok{show.stat =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
